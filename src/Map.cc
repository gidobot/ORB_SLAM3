...
void Map::PostLoad(KeyFrameDatabase* pKFDB, SIFTVocabulary* pSIFTVoc/*, map<long unsigned int, KeyFrame*>& mpKeyFrameId*/, map<unsigned int, GeometricCamera*> &mpCams)
{
    ...
    for(KeyFrame* pKFi : mspKeyFrames)
    {
        ...
        pKFi->UpdateMap(this);
        pKFi->SetSIFTVocabulary(pSIFTVoc);

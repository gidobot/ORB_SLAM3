...
void Atlas::PostLoad()
{
    ...
    {
        mspMaps.insert(pMi);
        pMi->PostLoad(mpKeyFrameDB, mpSIFTVocabulary, mpCams);
...
void Atlas::SetSIFTVocabulary(SIFTVocabulary* pSIFTVoc)
{
    mpSIFTVocabulary = pSIFTVoc;
}

SIFTVocabulary* Atlas::GetSIFTVocabulary()
{
    return mpSIFTVocabulary;
}

...
vector<double> VisualOdometryMono::estimateMotion (vector<Matcher_SIFT::p_match> p_matched) {
  ...
  Matrix Tp,Tc;
  vector<Matcher_SIFT::p_match> p_matched_normalized = p_matched;
...
bool VisualOdometryMono::normalizeFeaturePoints(vector<Matcher_SIFT::p_match> &p_matched,Matrix &Tp,Matrix &Tc) {
...
void VisualOdometryMono::fundamentalMatrix (const vector<Matcher_SIFT::p_match> &p_matched,const vector<int32_t> &active,Matrix &F) {
  ...
  for (int32_t i=0; i<N; i++) {
    Matcher_SIFT::p_match m = p_matched[active[i]];
...
vector<int32_t> VisualOdometryMono::getInlier (vector<Matcher_SIFT::p_match> &p_matched,Matrix &F) {
...
void VisualOdometryMono::EtoRt(Matrix &E,Matrix &K,vector<Matcher_SIFT::p_match> &p_matched,Matrix &X,Matrix &R,Matrix &t) {
...
int32_t VisualOdometryMono::triangulateChieral (vector<Matcher_SIFT::p_match> &p_matched,Matrix &K,Matrix &R,Matrix &t,Matrix &X) {
